...
-- pipeline whenever a .papyri artifact is ingested — via PUT /api/bundle or
-- the standalone `papyri-ingest` CLI (both decode a packed artifact and know
-- its compressed byte length).
--
