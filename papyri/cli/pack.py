...
def pack(
    ...
    strict: Annotated[
        ...
        typer.Option(
            "--strict",
            "-s",
            help="Promote bundle-lint warnings to errors and refuse to pack: dangling local refs, orphan narrative docs (present but unreachable from any toc entry), and missing Figure assets. (Substitution nodes and docstring-parse-failure sentinels always refuse to pack, strict or not.) Use in CI to catch toctree/cross-ref regressions.",
        ),
    ] = False,
) -> None:
    """
