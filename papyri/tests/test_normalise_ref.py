...
def test_builtins_are_passthrough() -> None:
...
def test_main_is_passthrough() -> None:
    assert normalise_ref("__main__.foo") == "__main__.foo"


def test_unimportable_passthrough() -> None:
...
def test_resolved_function_returns_canonical_path() -> None:
